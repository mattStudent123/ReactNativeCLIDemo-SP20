...
const HorizontalCard = ({item, nav}) => {
  return (
    <TouchableHighlight
      activeOpacity={0.6}
      underlayColor="#F3F4F8"
      onPress={() => nav.navigate('RecipeDetails')}>
      <View style={[styles.horizontalCard, styles.card]}>
        <Image
          style={styles.horizontalCard.horizontalCardImg}
          source={{uri: item.image}}
        />
        <View style={[styles.recipeDetails, styles.recipeDetails.horizontal]}>
          <View>
